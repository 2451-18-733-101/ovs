...
session_start();
if(empty($_POST['lan'])){
$error="<center><h4><font color='#008B8B'>Please select a Political Party to vote!</h4></center></font>";
include"voter.php";
exit();
}
$lan = $_POST['lan'];
...
$sql1 =mysqli_query($con, 'UPDATE politicalparties SET votecount = votecount + 1 WHERE name = "'.$_POST['lan'].'"');
